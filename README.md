...
This project is my answer: a supervisor graph with plan-and-execute and a review loop, backed by a run-level circuit breaker, batched post-hoc rescue, budget-triggered working-memory compaction, an offline golden-set evaluation, and 302 unit tests.
...
| Quality | pytest (302) · JSONL traces · golden-set eval · LLM-as-judge · CI |
...
├── tests/           # 302 unit tests (safety / plan / tools / ReAct / budgeting /
